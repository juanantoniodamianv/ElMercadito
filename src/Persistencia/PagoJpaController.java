...
//metodo de jpaController. Create
    public void create(Pago pago) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findPago(pago.getCodigoPago()) != null) {
...
//    método de jpaController: obtener un elemento
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("The pago with codigoPago " + id + " no longer exists.", enfe);
            }
            em.remove(pago);
            em.getTransaction().commit();
        } finally {
    ...
    private Object findPago(String id) {
