 ...
 * @author daniel
 */
public class SucursalJpaController1 implements Serializable {

    public SucursalJpaController1(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(Sucursal sucursal) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findSucursal(sucursal.getNroSucursal()) != null) {
    ...
    public void edit(Sucursal sucursal) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                int id = sucursal.getNroSucursal();
